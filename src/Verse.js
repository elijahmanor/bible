...
const APPLICATION_KEY = "Token ac5dbbb40e770d62bbfdcfe1e6d45aa36df5e970";
...
export default function Verse(props) {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [verse.text, dispatch, props.reference, verse.reference]);
  ...
  return (
    <>
      ...
      <div style={{ margin: "0 1rem" }} contentEditable={false}>
        ...
        <h2
          style={{ margin: "0" }}
        >{`${verse.book} ${verse.chapter}:${verse.verse}`}</h2>
        {gameIndex === -1 ? (
          <>
